        ...
        return(
            <div className="da-shell">
                <div className="da-titlebar">
                    <div className="da-logo">{Ic.logo}</div>
            ...
            <div className="da-ribbon">
                ...
                <div className="da-section">
                    <span className="da-section-label">Size</span>
                    <div className="da-section-row">
                        {STROKE_SIZES.map(s=>(
                            <button key={s.key} className={`da-stroke-pick${strokePx===s.px ? ' active' : ''}`} onClick={()=>setStrokePx(s.px)} title={`${s.px}px`}>
                                {strokeDot(s.px)}
                            </button>
                        ))}
                    </div>
                ...
                <div className="da-section">
                    <span className="da-section-label">Opacity</span>
                    <div className="da-opacity-row">
                        <span className="da-opacity-label">Amount</span>
                        <input className="da-opacity-slider" type="range" min="5" max="100" step="1" value={opacity} onChange={e=>setOpacity(Number(e.target.value))} title="Opacity" />
                        <span className="da-opacity-val">{opacity}%</span>
                    </div>
                </div>
                <div className="da-ribbon-sep" />
